...
This repository contains tools and resources I’ve developed for both groups and individual Hoppous.  
All available materials are open resource, so use them as you'd like.
...
They may be copied, edited, shared, and freely used, provided that:
- Appropriate credit is given.
- The material is not misrepresented as original work by others.
- The work is not altered or used in a way that distorts its intent or purpose.
- The material is not used for political, personal, or group-related disputes.
